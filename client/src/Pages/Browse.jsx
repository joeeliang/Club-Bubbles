...
const clubsData = [
    ...
    { id: 2, name: "Art Club", description: "Explore your artistic side." },
    { id: 3, name: "Music Club", description: "For music lovers and musicians." },
    { id: 4, name: "Book Club", description: "Read and discuss great books." },
    { id: 5, name: "Sports Club", description: "For sports and fitness activities." },
];
